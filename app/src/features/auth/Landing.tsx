...
export function Landing() {
          ...
          <div className="glass-effect rounded-2xl shadow-2xl p-8 border-2 border-white/20 backdrop-blur-xl">
            ...
            <div className="mt-6 text-center">
              <p className="text-xs text-white/50 flex items-center justify-center gap-2">
                ...
                <span>Connect to Sepolia Testnet</span>
              </p>
            </div>
          </div>
  ...
  if (activeTableId !== null) {
    return (
      <SessionProvider>
        <TableView tableId={activeTableId} onBack={() => setActiveTableId(null)} />
      </SessionProvider>
    );
  }
  ...
  if (showBrowser) {
    return (
      <SessionProvider>
        <TableBrowser onSelectTable={(tableId) => setActiveTableId(tableId)} />
      </SessionProvider>
    );
  }
              ...
              <div className="flex items-start gap-3">
                ...
                <div className="flex-1">
                  ...
                  <p className="text-xs text-red-100/80 mb-3 leading-relaxed">
                    ...
                    <br />
                    Required: Sepolia (Chain ID: {SEPOLIA_CHAIN_ID})
                  </p>
                  <button
